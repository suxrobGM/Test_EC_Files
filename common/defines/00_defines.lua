...
NGame = {
	START_DATE = "1985.5.1.12",						-- EC Edit
	END_DATE = "2035.1.1.1",						-- EC Edit
	...
	MESSAGE_TIMEOUT_DAYS = 30,						-- EC Edit; Useful if running the handsoff game. The popup messages that doesn't require the player respond will automatically hide after some timeout.	
...
NDiplomacy = {
	...
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.1,			-- EC Edit; # Amount of tension generated for each sent division
	...
	TENSION_TIME_SCALE_START_DATE = "1985.1.1.12",	-- EC Edit; # Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	MAX_OPINION_FROM_VOLUNTEERS = 10,				-- EC Edit; # Opinion bonus per one sent volunteer division
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.2,			-- EC Edit; # ideology limit required to join faction
...
NCountry = {
	...
	BASE_RESEARCH_SLOTS = 4,						-- EC Edit; # Base number of research slots per country.
...
NProduction = {
	MAX_EQUIPMENT_RESOURCES_NEED = 4, 	--EC Edit; # Max number of different strategic resources an equipment can be dependent on.
	MAX_CIV_FACTORIES_PER_LINE = 20,	--EC Edit; # Max number of factories that can be assigned a single production line.
	MAX_NAV_FACTORIES_PER_LINE = 20,	-- EC Edit;
	...
	CAPITULATE_STOCKPILES_RATIO = 0.75, -- EC Edit; How much equipment from deployed divisions will be transferred on capitulation
...
NTechnology = {
	MAX_SUBTECHS = 6,					    -- EC Edit; # Max number of sub technologies a technology can have.
...
NBuildings = {
	...
	RADAR_RANGE_MAX = 1000,				--  EC Edit; # Range is interpolated between building levels 1-15.
	...
	MAX_SHARED_SLOTS = 40,				-- EC Edit; # Max slots shared by factories
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 10,			-- EC Edit; # how many brigades a corps commander is limited to. 0 = inf, < 0 = blocked
	CORPS_COMMANDER_ARMIES_CAP = -1,			-- EC Edit; # how many division, corps or armies a corps commander is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_DIVISIONS_CAP = -1,			-- EC Edit; # how many brigades a field marshall is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_ARMIES_CAP = 20,				-- EC Edit; # how many division, corps or armies a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	MAX_DIVISION_BRIGADE_WIDTH = 10,			-- EC Edit; # Max width of regiments in division designer.
	MAX_DIVISION_BRIGADE_HEIGHT = 6,		-- EC Edit; # Max height of regiments in division designer.
	MAX_DIVISION_SUPPORT_WIDTH = 2,			-- EC Edit; # Max width of support in division designer.
	MAX_DIVISION_SUPPORT_HEIGHT = 6,		-- EC Edit; # Max height of support in division designer.
	...
	AIR_SUPPORT_BASE = 0.25,                        -- base ground bonus to troops when active planes helping them
	...
	NUKE_MIN_DAMAGE_PERCENT = 0.5,					-- EC Edit; #Minimum damage from nukes as a percentage of current strength/organisation
...
NAir = {
	...
	STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 0.0,			--  EC Edit; #How much air superiority is needed for a tactical bomber to be able to nuke a province
	AGGRESSION_THRESHOLD = { 0.0, 0.25, 0.5 },			-- Threshold levels for mission aggressivity for air
	ACE_WING_SIZE =	30.0,									-- # EC Edit; airwing to squadron; size of wing ace bonuses are set up for. if lower more bonus, if higher less bonus
...
NAI = {
	...
	DIVISION_DESIGN_COMBAT_WIDTH_WEIGHT = -5.0,				-- EC Edit; old version parametr -3.0, in 1.3.3 -1.0  # This score is reduced the higher width is when comparing pure changes with no target
