...
NGraphics = {
	...
	LIGHT_HDR_RANGE = 1.0,
	BORDER_WIDTH = 1.5,
	PROVINCE_BORDER_FADE_NEAR = 215,				-- EC Edit: PROVINCE_BORDER_FADE_NEAR = 200 
	PROVINCE_BORDER_FADE_FAR = 310,					-- EC Edit: PROVINCE_BORDER_FADE_FAR = 300
	STATE_BORDER_FADE_NEAR = 410,					-- EC Edit: STATE_BORDER_FADE_NEAR = 400
	STATE_BORDER_FADE_FAR = 550,					-- EC Edit: STATE_BORDER_FADE_FAR = 500
	...
	GRADIENT_BORDERS_CAMERA_DISTANCE_OVERRIDE_STATE = 0.0, 	-- EC Edit:
	GRADIENT_BORDERS_CAMERA_DISTANCE_OVERRIDE_SUPPLY_AREA = 0.0, -- EC Edit: 
	GRADIENT_BORDERS_CAMERA_DISTANCE_OVERRIDE_STRATEGIC_REGIONS = 0.0, -- EC Edit: 
	...
	GRADIENT_BORDERS_OPTIMIZATION_RANGE = 20.0, -- EC Edit: smaller value = faster gradient borders but may have artifacts on large provinces (value to balance)
	...
	COUNTRY_FLAG_TEX_MAX_SIZE = 2048, -- EC edit; Tweak dependly on amount of countries. Must be power of 2. No more then 2048.
	COUNTRY_FLAG_SMALL_TEX_MAX_SIZE = 512, -- EC edit; Tweak dependly on amount of countries. Must be power of 2. No more then 2048.
	COUNTRY_FLAG_STRIPE_TEX_MAX_WIDTH = 10, -- EC edit; 
	COUNTRY_FLAG_STRIPE_TEX_MAX_HEIGHT = 8196, -- EC edit; 
	COUNTRY_FLAG_LARGE_STRIPE_MAX_WIDTH = 41, -- EC edit; 
	COUNTRY_FLAG_LARGE_STRIPE_MAX_HEIGHT = 24000, -- EC edit; 
	VICTORY_POINT_LEVELS = 2,
	VICTORY_POINT_MAP_ICON_AFTER = {0, 20}, -- After this amount of VP the map icon becomes bigger dot.
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {100, 250, 500 }, -- {100, 250, 500},  -- EC Edit; At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {300, 500, 1500 }, -- {300, 500, 1500 }, -- EC Edit; At what distance VPs are hidden
	...
	WEATHER_DISTANCE_CUTOFF = 1450, -- EC Edit: WEATHER_DISTANCE_CUTOFF = 1500 At what distance weather effects are hidden
